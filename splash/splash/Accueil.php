            ...
            <div class="gtco-container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                        ...
                        <img src="images/AfficheSemaine.jpg" alt="Image" class="imageaffsemaine">
                        <p>Ce dimanche, le Paris Saint-Germaint se déplace à Geoffroy Guichard pour l'avant dernière
                            journée de la ligue 1 . Le PSG doit impérativement s'imposer face à St-Etienne
                            s'ils veulent rester dans la course au titre.
                            Face à une équipe de St-Etienne solide à Domicile, Paris peut-il rester dans
                            la course au titre ?</p>
                    ...
                    <div class="gtco-container">
						...
						<span class="icon">
							<i class="ti-alarm-clock"></i>
                                    ...
                                    <span class="counter-label">Nombre d'heures passés à coder ce site</span>
						...
						<span class="icon">
							<i class="ti-face-smile"></i>
                                    ...
                                    <?php
                                    $req = "select count(id) from UserProfil";
						...
						<span class="icon">
							<i class="ti-calendar"></i>
                                    ...
                                    <?php
                                    $req = "select count(id) from PronoUser";
                                    $reponse = $connexion->prepare($req);
                                    $reponse->execute();
                                    $nbmatch = $reponse->fetchColumn();
                                    echo"<span class=\"counter js-counter\" data-from=\"0\" data-to =\"";
                                    echo $nbmatch;
                                    echo"\" data-speed=\"5000\" data-refresh-interval=\"50\">1</span>";
                                    ?>
                                    <span class="counter-label">Nombre de matchs pronostiqués </span>
